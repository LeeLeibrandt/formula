    ...
    <div class="container p-t-0 m-t-2 carousel-inner">
        <div class="row row-equal carousel-item active m-t-0">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-img-top card-img-top-250">
                        <img class="img-fluid" src="img/track/00.png" alt="Carousel 1">
                    </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-img-top card-img-top-250">
                        <img class="img-fluid" src="img/track/00.png" alt="Carousel 2">
                    </div>
                    <div class="card-block p-t-2">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-img-top card-img-top-250">
                        <img class="img-fluid" src="img/track/00.png" alt="Carousel 3">
                    </div>
                    <div class="card-block p-t-2">
        ...
        <div class="row row-equal carousel-item m-t-0">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-img-top card-img-top-250">
                        <img class="img-fluid" src="img/track/00.png" alt="Carousel 4">
                    </div>
                    <div class="card-block p-t-2">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-img-top card-img-top-250">
                        <img class="img-fluid" src="img/track/00.png" alt="Carousel 5">
                    </div>
                    <div class="card-block p-t-2">
